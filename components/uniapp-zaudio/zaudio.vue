<template>
	<view class="imt-audio" :class="[`${theme}`]" v-if="audiolist.length > 0">
		<template v-if="theme == 'theme3'">
			...
			<view class="top">
				<view class="audio-control-wrapper">
					...
					<image :src="require('./static/images/loading.png')" v-if="loading" class="play loading"></image>
					<template v-else>
						<image :src="require('./static/images/playbtn.png')" alt="" @click="operate" class="play" v-if="renderData('paused')"></image>
						<image :src="require('./static/images/pausebtn.png')" alt="" @click="operate" class="play" v-else></image>
					</template>
				</view>
			</view>
		...
		<!-- 	<view class="top">
			...
			<view class="audio-button-box" style="margin-top:10upx;">
				<!-- 块退15s -->
			<!-- 	<image :src="require('./static/images/prev.png')" class="prevbtn" @click="stepPlay(-15)" mode="widthFix"></image> -->
				<!-- 上一首 -->
				<!-- <image :src="require('./static/images/go.png')" class="prevplay" @click="changeplay(-1)" mode="widthFix"></image> -->
				<div class="playbox">
					<image :src="require('./static/images/loading2.png')" v-if="loading" class="play loading"></image>
					<template v-else>
						<!-- 播放 -->
						<image :src="require('./static/images/playbtn2.png')" alt="" @click="operate" class="play" v-if="renderData('paused')"></image>
						<!-- 暂停 -->
						<image :src="require('./static/images/pausebtn2.png')" alt="" @click="operate" class="pause" v-else></image>
					</template>
				</div>
				<!-- 下一首 -->
			<!-- 	<image :src="require('./static/images/go.png')" class="nextplay" @click="changeplay(1)" mode="widthFix"></image> -->
				<!-- 快进15s -->
				<!-- <image :src="require('./static/images/next.png')" class="nextbtn" @click="stepPlay(15)" mode="widthFix"></image> -->
			</view>
		</template>
	</view>
</template>
